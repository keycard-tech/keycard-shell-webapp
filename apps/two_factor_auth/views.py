...
class AdminSetupTwoFactorAuthView(TemplateView):
    template_name = "admin/setup_two_factor_auth.html"
...
class AdminConfirmTwoFactorAuthView(FormView):
    template_name = "admin/confirm_two_factor_auth.html"
    ...
    class Form(forms.Form):
        ...
        def clean_otp(self):
            self.two_factor_auth_data = UserTwoFactorAuth.objects.filter(user=self.user).first()
    ...
    def form_valid(self, form):
        ...
        self.request.session["two_factor_auth_token"] = str(form.two_factor_auth_data.session_identifier)
